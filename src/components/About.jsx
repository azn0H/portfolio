              ...
              {t.about.stats.map((stat, i) => (
                <motion.div
                  ...
                  className={`p-5 rounded-2xl border cursor-default transition-shadow duration-300 ${
                    darkMode ? 'bg-white/4 border-white/8 hover:border-white/15' : 'bg-white border-gray-200 hover:border-indigo-200 hover:shadow-md'
                  }`}
                >
          ...
          >
            ...
            <motion.div
              ...
              className={`mt-10 p-5 rounded-2xl border ${
                darkMode ? 'bg-accent-indigo/5 border-accent-indigo/15' : 'bg-indigo-50 border-indigo-100'
              }`}
            >
